  ...
  const arr = [
    {
      ...
      imageRow1:
        "https://www.frontrangelocksmith.com/images/denver-skyline.jpeg",
      ...
      image2: "https://www.frontrangelocksmith.com/images/parked-car.jpeg",
      ...
      <div className="List marginTop20">
        <ul className="LinkList">
          {props.linkList.map((e) => {
            return (
              <li className="linkList adse fontsLine">
                <Link state={props.item == '1' ? arr[0]: props.item == '2' ? arr[1] :props.item == '3' ? arr[2]:arr[3]} to={"/servicepage"}>{e}</Link>
              </li>
            );
          })}
        </ul>
